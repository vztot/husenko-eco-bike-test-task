...
public class FindAndListAllItemsController {
    ...
    public FindAndListAllItemsController() {
        drawMenu();
        String ans = "";
    ...
    private void drawMenu() {
        TextTable table = new TextTable(new String[]{"#", "Select type of a bikes you would like "
    ...
    private void searchSpeedelec() {
        ...
        OutputUtil.soutListWithPages(searchService.searchSpeedelec(speedelec).stream()
                .map(e -> e.toCatalogString())
                .collect(Collectors.toList()));
    }
    ...
    private void searchEbike() {
        ...
        OutputUtil.soutListWithPages(searchService.searchEbike(ebike).stream()
                .map(e -> e.toCatalogString())
                .collect(Collectors.toList()));
    }
}
